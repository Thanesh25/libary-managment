    ...
    <div className="col-xl-4 col-12 col-md-6 margin-right">
      <div className="book-details mt-2 mb-2">
        {isEditing ? (
          ...
          <>
            <p>
              <span className="fw-semibold purple fw-bold">Book Name:</span>{" "}
              {book.bookTitle}
            </p>
            <p>
              <span className="fw-semibold purple fw-bold">ISBN Number: </span>{" "}
              {book.isbnNumber}
            </p>
            <p>
              {" "}
              <span className="fw-semibold purple fw-bold">
                Publication Date:{" "}
              </span>{" "}
        ...
        <div className="d-flex justify-content-between align-items-center">
          {!showMoreStatus ? (
            ...
            <p onClick={readLess} className="read-more">
              Show Less
            </p>
          )}
          <div>
            {isEditing ? (
              ...
              <button onClick={handleEditClick} className="custom-btn edit-btn">
                Edit
              </button>
            )}
            <button
      ...
      <div
        className={
          showMoreStatus ? "author-details display mt-1" : "author-details"
        }
      >
        ...
        {isEditing ? (
          ...
          <>
            <p>
              <span className="fw-bold">Author Name:</span> {book.authorName}
            </p>
            <p>
            ...
            <p>
              {" "}
              <span className="fw-bold">Biography: </span> {book.biography}
            </p>
          </>
        )}
      </div>
